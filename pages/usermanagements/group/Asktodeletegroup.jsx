...
function Asktodeletegroup({groupName,closeBox, setopen, deleteGroup}) {
  return (
      ...
      <div className={classes.msgbox}>
        <div className={classes.msgboxTop}>
          <div className={classes.msgboxTopIconBox}>
            ...
            <h1>Are you sure to delete {groupName} group</h1>
            <p>
              Warning check before to remove this group may cause conflicts in
              system
            </p>
...
<Button startIcon={<DeleteIcon />} onClick={deleteGroup} variant="contained" sx={{
...
export default Asktodeletegroup;
