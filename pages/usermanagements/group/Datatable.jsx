...
import { getgroups, DeleteGroup, UPDATEGroup } from "../../../features/groups/groups.js";
...
function Datatable() {
  ...
  const makereport = () => {
    ...
    doc.text(`ID: ${itm.group_id} User ID:${itm.user_id}`, 40, 75); // X, Y
    doc.setFont("helvetica", "normal");
    doc.text(`Group: ${itm.group_name} Description: ${itm.description}`, 40, 95); // X, Y
  ...
  const Update_info = (e) => {
    ...
    enqueueSnackbar(`${e.data.group_name} has been updated`, { variant: "success" });
  }
  ...
  return (
    ...
    >
      ...
      <Asktodeletegroup sectionName={currentsectName} setopen={openaskmsg} closeBox={closemsgbox} deleteSection={DltGroup} />
      ...
      <div style={{
        ...
        >
          ...
          <Column dataField="group_id" caption="Group ID" dataType="Guid" allowEditing={false} width={70} visible={false} />
          ...
          >
            ...
            <Form>
              <Item itemType="group" colCount={2} colSpan={2}>
                <Item dataField="group_id" visible={false} />
                <Item dataField="group_name" />
            ...
            component={(e) => {
              return (
                <div>
                  ...
                  {Loaddatas
                    .filter((item) => item.group_id === e.data.key)
                    .map((itm) => {
                      return (
                        <div
                          style={{
                        ...
                        >
                          <h3>
                            Group name: {itm.group_name} and Status: {itm.status == "1" ? "Activated" : "Not Active"}
                          </h3>
                          <br />
          ...
          <Summary>
            <TotalItem column="group_name" summaryType="count" />
